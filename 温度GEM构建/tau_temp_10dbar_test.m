    ...
    for j = 1:length(data_GOM)
        ...
        %for k =1:30
            if isempty(data_GOM{1,j})
              ...
              % 找出值为 10 的元素索引
              index = find(data_GOM{1,j}.P_adj_sample_noNaN == 1000);
        ...
        %end
              ...
              temp_total = [temp_total,data_GOM{1,j}.S_adj_sample_noNaN(index)];
    end
end
...
load('D:\Program Files (x86)\MATLAB\matlab_study\GEM构建\tau_total.mat');
%%
%绘制点
