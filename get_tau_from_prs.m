function [integral_tau,rho,c] = get_tau_from_prs(filename,prs_start,prs_stop)
...
%%
    ...
    for i = 1:length(data_GOM)
        ...
        pres{k} = data_GOM{1, i}.P_adj_sample_noNaN(prs_start/dp + 1 : prs_stop/dp+1);
        temp{k} = data_GOM{1, i}.T_adj_sample_noNaN(prs_start/dp + 1 : prs_stop/dp+1);
        psal{k} = data_GOM{1, i}.S_adj_sample_noNaN(prs_start/dp + 1 : prs_stop/dp+1);
        k = k+1;
    end
    %%
